...
import shirt1 from '../assets/Hoodie_1.jpg';
import shirt2 from '../assets/Hoodie_2.jpg';
import shirt3 from '../assets/Hoodie_3.jpg';
import shirt4 from '../assets/Hoodie_4.jpg';
import shirt5 from '../assets/Hoodie_5.jpg';
import shirt6 from '../assets/Hoodie_6.jpg';
import Footer from '../components/Footer';
import cartIcon from '../assets/cart.jpg'; // Add your own cart icon image here

const products = [
  { id: 1, name: 'Dark Blue Cotton Hoodie', price: '₹25.00', image: shirt1 },
  { id: 2, name: 'Wide Fit White Cotton Hoodie', price: '₹28.00', image: shirt2 },
  { id: 3, name: 'Buttoned Down Lilac Hoodie', price: '₹60.00', image: shirt3 },
  { id: 4, name: 'Slim Fit Black Hoodie', price: '₹45.00', image: shirt4 },
  { id: 5, name: 'Classic Plaid Hoodie', price: '₹50.00', image: shirt5 },
  { id: 6, name: 'Soft Blue Denim Hoodie', price: '₹55.00', image: shirt6 },
];
      ...
      <div className="min-h-screen bg-white font-sans">
        ...
        <nav className="flex items-center justify-between p-6 border-b">
          ...
          <ul className="hidden md:flex space-x-8 text-gray-700">
            ...
            <li className="hover:text-black cursor-pointer border-b-2 border-black">Hoodies</li>
        ...
        <div className="flex flex-col md:flex-row p-6">
          ...
          <aside className="md:w-1/4 mb-6 md:mb-0 md:pr-8 border-r">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="hover:text-black cursor-pointer font-bold">Hoodies</li>
