...
export default function Portfolio() {
  const portfolioItems = [
    { title: "Portraits", img: wedding1 },
    { title: "Pre Weddings", img: wedding2 },
    { title: "Tamil Weddings", img: wedding3 },
    { title: "Telugu Weddings", img: wedding4 },
    { title: "Christian Weddings", img: wedding5 },
    { title: "Muslim Weddings", img: tee10 },
  ];
    ...
    <section className="bg-gray-100 py-20 px-4">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {portfolioItems.map((item, idx) => (
          <div
            key={idx}
            className="relative group h-72 sm:h-80 lg:h-96 overflow-hidden rounded-xl shadow-lg"
          >
            <img
              src={item.img}
              alt={item.title}
